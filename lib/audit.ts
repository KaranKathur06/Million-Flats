...
export type AuditAction =
  ...
  | 'ADMIN_AGENT_UNDER_REVIEW'
  | 'ADMIN_AGENT_REJECTED'
  | 'ADMIN_AGENT_FLAGGED'
  ...
  | 'ADMIN_ECOSYSTEM_PARTNER_CREATED'
  | 'ADMIN_ECOSYSTEM_PARTNER_UPDATED'
  | 'ADMIN_ECOSYSTEM_PARTNER_STATUS_CHANGED'
  | 'ADMIN_ECOSYSTEM_PARTNER_VERIFICATION_CHANGED'
  | 'ADMIN_ECOSYSTEM_PARTNER_FEATURED_CHANGED'
  | 'ADMIN_ECOSYSTEM_PARTNER_MEDIA_UPLOADED'
  | 'ADMIN_ECOSYSTEM_PARTNER_MEDIA_REPLACED'
  | 'ADMIN_ECOSYSTEM_PARTNER_MEDIA_DELETED'
  | 'ADMIN_HERO_BANNER_CREATED'
