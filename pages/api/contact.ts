...
export default function handler(
  ...
  return void (async () => {
    try {
      ...
      const { contactSubjectToCategory, createLead } = await import('@/lib/leads/createLead')
      const contactCategory = contactSubjectToCategory(String(subject))
      ...
      await createLead({
        ...
        legacyTable: 'contact_submissions',
        legacyId: submission.id,
      }).catch((err) => console.error('Lead create (contact):', err))
