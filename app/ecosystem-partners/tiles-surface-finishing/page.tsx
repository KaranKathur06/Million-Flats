...
export const metadata = {
  title: 'Tiles & Surface Finishing - Coming Soon | MillionFlats',
}
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 pt-14 pb-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl font-serif font-bold text-dark-blue">Tiles & Surface Finishing</h1>
