...
export default async function Head({
  ...
  const category = await prisma.ecosystemCategory.findUnique({ where: { slug: cfg.slug }, select: { id: true } })
  ...
  const { prev, next } = buildPrevNext({ slug: params.slug, page, totalPages })
