  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-sky-200 selection:text-sky-900 flex flex-col relative overflow-hidden">
      ...
      <EcosystemPartnerDirectorySection
        categorySlug="property-insurance"
        title="Insurance Directory"
        subtitle="Filter and find strictly verified partners guaranteeing absolute coverage."
      />
      ...
      {/* CTA — Partner Registration */}
      <section className="bg-dark-blue py-20 text-center relative overflow-hidden">
        <div className="mx-auto max-w-[800px] px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-3xl sm:text-4xl font-sans font-extrabold text-white leading-[1.15] mb-4 tracking-tight">
            Join Our Verified Insurance Network
          </h2>
          <p className="text-white/60 text-lg font-medium leading-relaxed mb-10 max-w-xl mx-auto">
            Connect your insurance products with motivated property buyers and owners on MillionFlats.
          </p>
          <Link
            href="/ecosystem/register/property-insurance"
            className="group inline-flex items-center justify-center h-14 px-10 rounded-2xl bg-accent-yellow text-dark-blue font-extrabold text-lg transition-all shadow-lg hover:shadow-[0_15px_40px_rgba(245,158,11,0.3)] hover:-translate-y-1"
          >
