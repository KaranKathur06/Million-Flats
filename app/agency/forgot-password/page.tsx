...
export const metadata: Metadata = {
  ...
  description: 'Reset your MillionFlats Agency Portal access via WhatsApp OTP.',
}
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-black/5 p-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200 text-amber-700 text-xs font-semibold rounded-full px-3 py-1 mb-5">
          ...
          <p className="text-sm text-gray-500 mb-8">
            Agency accounts use WhatsApp OTP authentication. Simply log in again using your registered WhatsApp number — no password needed.
          </p>
