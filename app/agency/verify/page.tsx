...
export const metadata: Metadata = {
  title: 'Verification Status | Agency Portal | MillionFlats',
  description: 'Check your agency verification and approval status on MillionFlats.',
}
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-black/5 p-8 text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200 text-amber-700 text-xs font-semibold rounded-full px-3 py-1 mb-4">
            <span className="h-1.5 w-1.5 rounded-full bg-amber-500 animate-pulse" />
            Under Review
          </div>

          <h1 className="text-2xl font-bold text-dark-blue mb-2">Agency Verification Pending</h1>
          <p className="text-sm text-gray-500 mb-8 max-w-sm mx-auto leading-relaxed">
            Your agency account has been submitted for review. Our team will verify your credentials and documents within 1–3 business days.
          </p>

          {/* Progress Steps */}
          <div className="space-y-3 mb-8 text-left">
            {[
              { step: 'Account Created', done: true, desc: 'Your agency account has been registered' },
              { step: 'Documents Submitted', done: true, desc: 'License and registration documents received' },
              { step: 'Under Review', done: false, active: true, desc: 'Our compliance team is reviewing your submission' },
              { step: 'Approved & Live', done: false, desc: 'Agency profile goes live on the marketplace' },
            ].map((item) => (
