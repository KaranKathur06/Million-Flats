...
export default function AuthUserLoginClient() {
    ...
    <AuthLayout title="Welcome Back" subtitle="Continue as a user">
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-end">
          <Link href="/user/forgot-password" className="text-sm font-medium text-dark-blue hover:text-dark-blue/80 transition-colors">
            Forgot password?
          </Link>
        </div>
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link href="/auth/user/register" className="font-semibold text-dark-blue hover:text-dark-blue/80 transition-colors">
            Create one
          </Link>
        </p>
