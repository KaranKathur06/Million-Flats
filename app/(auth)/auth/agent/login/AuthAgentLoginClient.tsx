...
export default function AuthAgentLoginClient() {
  ...
  return (
    <AgentAuthLayout title="Agent Portal" subtitle="Continue as an agent">
      <form className="space-y-4" onSubmit={handleSubmit}>
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl text-sm">
            ...
            {error === 'Please verify your email before signing in.' && (
              <Link
                href={`/agent/verify?email=${encodeURIComponent(formData.email)}`}
                className="block w-full text-center h-10 leading-10 rounded-xl font-medium bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200 mt-3"
              >
                Verify Email
              </Link>
            )}
        ...
        <div className="flex items-center justify-end">
          <Link href="/agent/forgot-password" className="text-sm font-medium text-dark-blue hover:text-dark-blue/80 transition-colors">
            Forgot password?
          </Link>
        </div>
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link href="/agent/auth?tab=register" className="font-semibold text-dark-blue hover:text-dark-blue/80 transition-colors">
            Register as Agent
          </Link>
        </p>
        ...
        <p className="text-center text-sm text-gray-600">
          Not an agent?{' '}
          <Link href="/auth/login" className="font-semibold text-dark-blue hover:text-dark-blue/80 transition-colors">
            Choose role
          </Link>
        </p>
      </form>
