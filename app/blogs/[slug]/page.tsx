...
import { fixImageUrl, fixHtmlImageUrls } from '@/lib/fixImageUrl'
...
export async function generateMetadata({ params }: BlogPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'article',
      images: blog.featuredImageUrl ? [{ url: fixImageUrl(blog.featuredImageUrl) }] : undefined,
    },
  }
}
    ...
    <main className="min-h-screen bg-white py-8 sm:py-10">
      ...
      <article className="mx-auto w-full max-w-[900px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-8 overflow-hidden rounded-2xl border border-gray-200">
          <Image
            src={fixImageUrl(blog.featuredImageUrl)}
        ...
        <section className="prose prose-gray max-w-none">
          <div dangerouslySetInnerHTML={{ __html: fixHtmlImageUrls(blog.contentHtml || blog.content || '') }} />
        </section>
      </article>
    </main>
  )
