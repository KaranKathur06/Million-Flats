 ...
 * Backend API now returns ready-made CDN URLs — this is a thin passthrough.
 * Kept as a function for uniform null/empty handling.
 */
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-12">
                                        ...
                                        {project.similarProjects.slice(0, 3).map((sp) => (
                                            <Link key={sp.id} href={`/projects/${sp.slug}`} className="group rounded-2xl overflow-hidden border border-gray-200 bg-white hover:shadow-lg transition-all">
                                                <div className="relative h-40 overflow-hidden bg-gray-100">
                                                    {sp.coverImage ? (
                                                        <Image src={sp.coverImage} alt={sp.name} fill sizes="(max-width: 640px) 100vw, 33vw" className="object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = fallbackImage }} />
                                                    ) : (
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-16 space-y-4">
                            ...
                            <AIShieldCTA projectSlug={project.slug} projectId={project.id} />
