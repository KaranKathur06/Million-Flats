export const metadata = {
  title: 'AI Analytics (AI™) - MillionFlats',
}
    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-200 selection:text-dark-blue flex flex-col relative overflow-hidden">
      ...
      <section className="relative pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full z-10 text-center lg:text-left flex flex-col lg:flex-row items-center gap-16">
        <div className="lg:w-1/2">
          ...
          <p className="mt-6 text-xl text-slate-600 leading-relaxed font-medium">
            Our AI™ suite analyzes millions of data points to give you accurate pricing, investment forecasts, and risk assessment – so you never rely on guesswork again.
          </p>
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 max-w-[1240px] mx-auto w-full z-10 py-20">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h3 className="text-4xl font-serif font-extrabold text-dark-blue">What Is AI™ Analytics?</h3>
          <p className="mt-5 text-lg text-slate-600 leading-relaxed font-medium">
            Artificial intelligence is transforming real estate, and MillionFlats is at the forefront. Our proprietary AI™ suite analyzes locality growth patterns, historical sales data, infrastructure projects, amenities, and market trends to generate accurate insights that would take humans weeks to compile .
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { key: 'view', title: 'AIView™', subtitle: 'Authenticity', desc: 'Detects manipulated images and ensures the listing matches reality. Is the property exactly as presented?', icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z', color: 'text-blue-600', bg: 'bg-blue-100/50' },
            { key: 'shield', title: 'AIShield™', subtitle: 'Pricing Fairness', desc: 'Compares against 50+ localized data points to flag over-pricing or uncover severe under-pricing. Is this a good deal?', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', color: 'text-emerald-600', bg: 'bg-emerald-100/50' },
            { key: 'index', title: 'AIIndex™', subtitle: 'Investment Potential', desc: 'Forecasts 1-5 year asset value based on infrastructure influx, demand, and micro-market trends. Will it appreciate?', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', color: 'text-indigo-600', bg: 'bg-indigo-100/50' },
            { key: 'title', title: 'AITitle™', subtitle: 'Legal Safety', desc: 'Cross-references title records, municipal approvals, and litigation history to flag risks before you commit.', icon: 'M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3', color: 'text-amber-600', bg: 'bg-amber-100/50' },
            { key: 'pro', title: 'AIPro™', subtitle: 'Agent Performance', desc: 'Scores real estate agents on response time, closure rate, and client satisfaction. Who can you truly trust?', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', color: 'text-purple-600', bg: 'bg-purple-100/50' },
          ].map((s) => (
          ...
          <div className="mt-12 rounded-[2.5rem] border border-slate-200 bg-white shadow-[0_20px_60px_rgba(0,0,0,0.05)] overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-base">
                ...
                <tbody className="divide-y divide-slate-100">
                  {[
                    ['AIView™ (Authenticity)', 'Basic', 'Full', 'Full + Priority'],
                    ['AIShield™ (Pricing)', '-', 'Included', 'Included + Alerts'],
                    ['AIIndex™ (Investment)', '-', 'Basic', 'Advanced'],
                    ['AIPro™ Agent Score', 'Standard', 'Enhanced', 'Featured Badge'],
      ...
      <section className="bg-dark-blue relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1000px] px-4 sm:px-6 lg:px-8 py-12 relative z-10 text-center">
          <h2 className="text-white font-serif font-extrabold text-4xl tracking-tight">Unlock AI™ Tools</h2>
