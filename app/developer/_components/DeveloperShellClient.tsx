                  ...
                  {item.children ? (
                    <>
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all ${active ? 'bg-dark-blue/10 text-dark-blue' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                          }`}
                      >
                        ...
                        <ul className="mt-0.5 ml-8 space-y-0.5">
                          {item.children.map(child => (
                            <li key={child.href}>
                              <Link
                                href={child.href}
                                className={`block px-3 py-2 rounded-lg text-sm transition-all ${pathname === child.href ? 'bg-dark-blue/10 text-dark-blue font-medium' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-900'
                                  }`}
                              >
                                {child.label}
                              </Link>
                    ...
                    <Link
                      href={item.href}
                      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all ${active ? 'bg-dark-blue/10 text-dark-blue' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                        }`}
                    >
                      <span className={active ? 'text-dark-blue' : 'text-gray-400'}>{item.icon}</span>
                      {item.label}
