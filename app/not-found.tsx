      ...
      <section className="bg-white">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 pt-14 pb-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl font-serif font-bold text-dark-blue">Coming Soon</h1>
            <p className="mt-4 text-lg text-gray-600">This page is not live yet. We are working on it and will launch it soon.</p>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 py-14">
          <div className="rounded-3xl border border-gray-200 bg-white shadow-sm p-8 sm:p-10">
            ...
            <div className="mt-3 text-gray-600">If you need help right now, reach out to our team and we’ll assist you.</div>
