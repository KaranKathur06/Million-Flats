...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      console.error('[agency/reset-password] Database error:', error)
    ...
    if ((resetToken.user as any).role !== 'AGENCY') {
      return NextResponse.json(
    ...
    try {
      ...
      console.error('[agency/reset-password] Password update error:', error)
      return NextResponse.json(
