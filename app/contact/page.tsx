            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              ...
              <div className="rounded-2xl border border-gray-200 bg-gray-50 p-6">
                <div className="max-w-full">
                  ...
                  <h3 className="mt-3 text-lg font-serif font-bold text-dark-blue">Schedule a Google Meet with our team</h3>
                  <p className="mt-3 text-gray-600">Book a 30-minute meeting between 10:00 AM and 8:00 PM. We will confirm your preferred slot and send the Google Meet link.</p>

                  {!showBookingFlow ? (
                    <div className="mt-6 space-y-4">
                      <div>
                        <label htmlFor="meeting-purpose-side" className="block text-sm font-medium text-gray-700 mb-2">Meeting Purpose</label>
                        <select
                          id="meeting-purpose-side"
                          value={selectedCategory}
                          onChange={(e) => setSelectedCategory(e.target.value as MeetingCategory)}
                          className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-900 focus:border-dark-blue focus:ring-2 focus:ring-dark-blue/20 transition-all"
                        >
                  ...
                  {showBookingFlow ? (
                    <div className="mt-6 rounded-2xl border border-gray-200 bg-gradient-to-br from-dark-blue to-[#0e2a58] p-4 sm:p-6">
                      <div className="mb-4 flex items-center justify-between gap-3">
                        <div>
                          <h4 className="text-lg font-semibold text-white">Book a meeting</h4>
                          <p className="text-sm text-white/70">{MEETING_CATEGORIES.find((c) => c.value === selectedCategory)?.label} — Select a date and time that works for you.</p>
                        </div>
                        <button
                          type="button"
