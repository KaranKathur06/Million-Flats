...
export default function PropertyListCard({ property, variant = 'grid' }: PropertyListCardProps) {
  ...
  const cardBase = 'bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden'
      ...
      <div className={cardBase}>
        ...
        <div className="p-4">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2 text-xs text-gray-600">
            <span className="rounded-xl bg-gray-50 px-2 py-2">{property.bedrooms} Beds</span>
            <span className="rounded-xl bg-gray-50 px-2 py-2">{property.bathrooms} Baths</span>
            <span className="rounded-xl bg-gray-50 px-2 py-2">{property.squareFeet.toLocaleString()} Sq Ft</span>
          </div>
  ...
  if (variant === 'list') {
    return (
      <div className={`${cardBase} overflow-hidden lg:flex lg:flex-row`}>
        ...
        <div className="p-6 lg:p-7 flex-1 flex flex-col justify-between gap-5">
          <div>
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="text-xs font-semibold text-gray-600 bg-gray-100 px-3 py-2 rounded-full">{property.propertyType}</span>
            </div>

            <p className="mt-4 text-sm text-gray-600">{property.bedrooms} Beds · {property.bathrooms} Baths · {property.squareFeet.toLocaleString()} Sq Ft</p>
          </div>
