        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 lg:[grid-template-columns:2.1fr_1fr_1.6fr_1fr_1fr_0.9fr] gap-8 lg:gap-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <GatedActionLink href="/ai/view" className="text-gray-600 hover:text-dark-blue text-sm transition-colors whitespace-nowrap">
                  AIView<sup>™</sup>
                </GatedActionLink>
              </li>
              <li>
                <GatedActionLink href="/ai/shield" className="text-gray-600 hover:text-dark-blue text-sm transition-colors whitespace-nowrap">
                  AIShield<sup>™</sup>
                </GatedActionLink>
              </li>
              <li>
                <GatedActionLink href="/ai/index" className="text-gray-600 hover:text-dark-blue text-sm transition-colors whitespace-nowrap">
                  AIIndex<sup>™</sup>
                </GatedActionLink>
              </li>
              <li>
                <GatedActionLink href="/ai/title" className="text-gray-600 hover:text-dark-blue text-sm transition-colors whitespace-nowrap">
                  AITitle<sup>™</sup>
                </GatedActionLink>
              </li>
              <li>
                <GatedActionLink href="/ai/pro" className="text-gray-600 hover:text-dark-blue text-sm transition-colors whitespace-nowrap">
                  AIPro<sup>™</sup>
                </GatedActionLink>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blogs" className="text-gray-600 hover:text-dark-blue text-sm transition-colors whitespace-nowrap">
                  Blog
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            {socialLinks.map((link) => {
              // Stroke-based icons (original Feather-style): Instagram, LinkedIn, Facebook, YouTube
