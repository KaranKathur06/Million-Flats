...
export default function AgentAuthLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-white via-[#F5F8FF] to-white">
      ...
      <div className="w-full lg:w-[520px] flex flex-col bg-white lg:bg-gradient-to-br lg:from-white lg:via-[#F5F8FF] lg:to-white -mt-10 lg:mt-0 rounded-t-[28px] lg:rounded-none shadow-[0_-18px_45px_rgba(10,25,60,0.10)] lg:shadow-none relative z-10 min-h-0">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-4 sm:px-8 pb-[calc(2rem+env(safe-area-inset-bottom))] lg:pb-6">
          <div className="w-full max-w-[460px] mx-auto py-6">
      ...
      <div className="hidden lg:flex flex-1 relative lg:sticky lg:top-0 lg:h-screen overflow-hidden">
