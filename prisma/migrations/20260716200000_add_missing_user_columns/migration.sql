...
ADD COLUMN IF NOT EXISTS bedrooms TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
ADD COLUMN IF NOT EXISTS preferred_cities TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
ADD COLUMN IF NOT EXISTS preferred_localities TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
ADD COLUMN IF NOT EXISTS buying_timeline TEXT,
ADD COLUMN IF NOT EXISTS investment_goal TEXT,
ADD COLUMN IF NOT EXISTS services_interested TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
ADD COLUMN IF NOT EXISTS communication_prefs TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
